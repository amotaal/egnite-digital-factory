  ...
  return (
    <html lang="en" className="h-full antialiased">
      <head>
        ...
        {/* Brand fonts applied to the whole app from the root layout. The
            next/no-page-custom-font rule targets per-page fonts — this one is
            global, so the warning doesn't apply. */}
